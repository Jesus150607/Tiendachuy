...
const imprimirAlumnos = () =>{
  ...
  x.forEach(a=>{
    ...
    <td>${a.g}</td>
    <td>${a.c}</td>
    <td><button class="btn btn-danger" onclick="delAlumnos(${index})"><i class="bi bi-trash-fill"></i></button></td>
<td><button class="btn btn-info" onclick="mostrarAlumnos(${index})" data-bs-toggle="modal" data-bs-target="#actualizarR">
